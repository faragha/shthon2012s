...
import shthon2012s.springaniki.DialNumber;
...
public class Utils {
    ...
    public static ArrayList<DialNumber> getAll(Activity act) {
        ...
        // Contacts.CONTENT_URI,
                ContactsContract.Contacts.CONTENT_URI, new String[] {
                        Contacts._ID, Contacts.LOOKUP_KEY, ContactsContract.Contacts.DISPLAY_NAME,
        ...
        if (c.moveToFirst()) {
            do {
                ...
                if (Integer.parseInt(c.getString(c
                    ...
                    cPhone = resolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
                            new String[] {
    ...
    public static void createDrawbleCollection() {
        ...
        // Rクラスの全ての内部クラスを取得
        Class<?>[] classes = shthon2012s.springaniki.R.class.getClasses();
    ...
    public static String getAnikiDir() {
        ...
        return Environment.getExternalStorageDirectory().getPath() + "/SpringAniki";
    }
}
