...
import shthon2012s.springaniki.Utils.DBG;
import shthon2012s.springaniki.Utils.Params;
import shthon2012s.springaniki.Utils.Utils;
import shthon2012s.springaniki.WebApis.UploadAsyncTask;
import shthon2012s.springaniki.WebApis.UploadAsyncTaskCallback;
import shthon2012s.springaniki.R;
...
public class ActCallList extends Activity implements UploadAsyncTaskCallback {
    ...
    private void SendSMS(String url) {
        ...
        smsManager.sendTextMessage(phoneNumber, null, "写真が届きました。 " + url,
                PendingIntent.getBroadcast(ActCallList.this, 0, new Intent(ACTION_SMS_SENT), 0),
                null);
    ...
    public void jsonCallback(String url, JSONObject json, AjaxStatus status) {
        if (json != null) {
            ...
            try {
                ...
                e.printStackTrace();
                progressDialog.dismiss();
                Toast.makeText(getApplicationContext(), "失敗しちゃったごめん", Toast.LENGTH_SHORT).show();
            }

        } else {
            DBG.LogOut(3, "jsonCallback", ":ajax error");
            Toast.makeText(getApplicationContext(), "失敗しちゃったよごめん", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onFailedUploadImage(int statusCode) {
        ...
        Toast.makeText(getApplicationContext(),
                "Failed, ResponseCode:" + Integer.toString(statusCode), Toast.LENGTH_SHORT).show();
    ...
    private BroadcastReceiver sms_bc = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (error) {
                ...
                Toast.makeText(getApplicationContext(), "失敗しちゃったごめんね", Toast.LENGTH_SHORT).show();
